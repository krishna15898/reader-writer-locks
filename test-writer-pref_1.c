...
int main(int argc, char *argv[])
{
	...
	writerAcquireTime = malloc(sizeof(long)*write_num_threads*3);
	writerReleaseTime = malloc(sizeof(long)*write_num_threads*3);
	pthread_mutex_init(&spinlock, 0);

	int num_threads = 4*read_num_threads + 3*write_num_threads;
